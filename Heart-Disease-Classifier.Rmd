...
```{r, echo=F, fig.width=8, fig.cap="\\label{fig:acc}Accuracy rates for the three classification methods"}
accuracy.df %>%
...
```{r, echo=F, fig.width=8, fig.cap="\\label{fig:lambda}Finding the minimum $\\lambda$ with ten-fold cross-validation (Run 5)"}
...
```{r, echo=F, fig.width=8, fig.cap="\\label{fig:k}Finding the optimal k with leave-one-out cross-validation (Run 5)"}
...
```{r, echo=F, fig.width=8, fig.cap="\\label{fig:size}Finding the best size with ten-fold cross-validation (Run 5)"}
